...
func (self *databaseTransaction) GetConfiguration(options *store.Option) (*models.Configuration, error) {
...
func (self *databaseTransaction) ModifyConfiguration(modifier func(*models.Configuration) error, options *store.Option) (*models.Configuration, error) {
	configuration, getError := self.GetConfiguration(options)
	if getError != nil {
		return nil, getError
	}
	...
	if configuration.CreatedAt != nil {
		createdAt = configuration.CreatedAt.UTC()
	}
