...
func main() {
	...
	generator.GenerateUpdate(new(models.JobRun))
	...
	generator.GenerateUpdate(new(models.MattermostConfiguration))
	...
	generator.GenerateGetters(new(models.JobRun))
	...
	generator.GenerateGetters(new(models.MattermostConfiguration))
