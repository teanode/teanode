...
func (self *api) handleMediaUpload(writer http.ResponseWriter, request *http.Request) error {
...
func (self *api) handleAudioTranscribe(writer http.ResponseWriter, request *http.Request) error {
	if request.Method != http.MethodPost {
		return web.Error(405, "method not allowed")
	}
...
func (self *api) handleAudioSynthesize(writer http.ResponseWriter, request *http.Request) error {
	if request.Method != http.MethodPost {
		return web.Error(405, "method not allowed")
	}
...
func (self *api) handleAudioStream(writer http.ResponseWriter, request *http.Request) error {
