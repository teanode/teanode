...
func (self *api) handleChatCompletionsSync(writer http.ResponseWriter, httpRequest *http.Request, request openaiRequest, agentId string, conversationId string, lastMessage openaiMessage) error {
...
func (self *api) handleChatCompletionsStream(writer http.ResponseWriter, httpRequest *http.Request, request openaiRequest, agentId string, conversationId string, lastMessage openaiMessage) error {
