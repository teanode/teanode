...
import { connect, disconnect, sendRpc, setEventHandler, setStatusHandler } from '../rpc';
...
export function useWebSocket({ onEvent, onConnect, onStatusChange }: UseWebSocketOptions) {
