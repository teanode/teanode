...
async function attachTab(tabId, opts = {}) {
  ...
  void chrome.action.setTitle({
    tabId,
    title: 'TeaNode Browser Relay: attached (click to detach)',
  })
...
async function detachTab(tabId, reason) {
  ...
  void chrome.action.setTitle({
    tabId,
    title: 'TeaNode Browser Relay (click to attach/detach)',
  })
}
...
async function connectOrToggleForActiveTab() {
  ...
  void chrome.action.setTitle({
    tabId,
    title: 'TeaNode Browser Relay: connecting to local relay…',
  })
  ...
  try {
    ...
    void chrome.action.setTitle({
      tabId,
      title: 'TeaNode Browser Relay: relay not running (open options for setup)',
    })
